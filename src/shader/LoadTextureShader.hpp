...
void LoadTextureShader(ES::Engine::Core &core)
{
    ...
    ambient_light.AddComponent<OpenGL::Component::ShaderHandle>(core, "texture");
    ...
    light_1.AddComponent<OpenGL::Component::ShaderHandle>(core, "texture");
    ...
    light_2.AddComponent<OpenGL::Component::ShaderHandle>(core, "texture");
    ...
    light_3.AddComponent<OpenGL::Component::ShaderHandle>(core, "texture");
    ...
    light_4.AddComponent<OpenGL::Component::ShaderHandle>(core, "texture");
